...
set (BERKLEY_DB_ROOT "${THIRDPARTY_DIRECTORY}/BerkeleyDB_4_8_30")

if (MSVC)

    #set (BERKLEY_DB_INCLUDE_DIR "${BERKLEY_DB_ROOT}/build_windows")
    set (BERKLEY_DB_INCLUDE_DIR "${BERKLEY_DB_ROOT}/include")
   ...
   #     )
    ...
    set (BERKLEY_DB_LIBRARIES
        debug "${BERKLEY_DB_ROOT}/lib/libdb48d.lib"
        optimized "${BERKLEY_DB_ROOT}/lib/libdb48.lib"
        )
