...
class IncludeConfTest(BitcoinTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "equibit.conf"), "a", encoding='utf8') as f:      ###HERE### bitcoin.conf
    ...
    def run_test(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "equibit.conf"), "a", encoding='utf8') as f:   ###HERE### bitcoin.cong
            f.write("includeconf=relative2.conf\n")
