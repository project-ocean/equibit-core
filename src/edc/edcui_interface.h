...
{
public:
    /** Flags for CEDCClientUIInterface::ThreadSafeMessageBox */
    enum MessageBoxFlags
    {
        ...
        ICON_ERROR          = (1U << 1),
        /**
         * Mask of all available icons in CEDCClientUIInterface::MessageBoxFlags
        ...
        /**
         * Mask of all available buttons in CEDCClientUIInterface::MessageBoxFlags
    ...
    boost::signals2::signal<void (CEDCWallet* wallet)> LoadWallet;
