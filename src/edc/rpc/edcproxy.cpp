...
void packIDs(std::vector<unsigned char>& data, const CKeyID& addr, const CKeyID& paddr, const CKeyID& iaddr)
{
...
void pack(std::vector<unsigned char>& data, const CKeyID& addr, const CKeyID& paddr, const std::string& pollid)
{
