...
// #define REGENERATE_TESTDATA
#ifdef REGENERATE_TESTDATA
        std::cout << "pubkey expected: " << derive.pub << std::endl;
        std::cout << "pubkey actual:   " << b58pubkey.ToString() << std::endl;

        std::cout << "prvkey expected: " << derive.prv << std::endl;
        std::cout << "prvkey actual:   " << b58key.ToString() << std::endl;
#endif
